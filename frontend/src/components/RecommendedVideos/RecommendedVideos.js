...
const RecommendedVideos = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=30&key=${process.env.REACT_APP_YOUTUBE_API_KEY}`
      )
      .then((response) => {
